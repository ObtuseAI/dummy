...
from predator_mesh.v77.reports import REPORT_GROUPS, V77ReportFactory

router = APIRouter(prefix="/api/v77", tags=["v77"])
...
def _safe(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    payload["api_can_fire_canary"] = False
    return payload


def _slice(*names: str) -> dict[str, Any]:
    reports = V77ReportFactory().build()
