...
from predator_mesh.v97.reports import REPORT_GROUPS, V97ReportFactory

router = APIRouter(prefix="/api/v97", tags=["v97"])
...
def _safe(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    payload["api_can_contact_broker"] = False
    return payload


def _slice(*names: str) -> dict[str, Any]:
    reports = V97ReportFactory().build()
