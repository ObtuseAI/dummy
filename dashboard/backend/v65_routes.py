...
from predator_mesh.v65.reports import REPORT_GROUPS, V65ReportFactory

router = APIRouter(prefix="/api/v65", tags=["v65"])
...
def _safe(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    payload["api_can_fire_order"] = False
    payload["api_can_submit_orders"] = False
    payload["api_can_access_account"] = False
    return payload


def _slice(*names: str) -> dict[str, Any]:
    reports = V65ReportFactory().build()
