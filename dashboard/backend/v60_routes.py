...
from predator_mesh.v60.reports import REPORT_GROUPS, V60ReportFactory

router = APIRouter(prefix="/api/v60", tags=["v60"])
...
def _safe(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    payload["api_can_release_quarantine_artifacts"] = False
    return payload


def _slice(*names: str) -> dict[str, Any]:
    reports = V60ReportFactory().build()
