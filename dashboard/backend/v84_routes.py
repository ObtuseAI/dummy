...
from predator_mesh.v84.reports import REPORT_GROUPS, V84ReportFactory

router = APIRouter(prefix="/api/v84", tags=["v84"])
...
def _safe(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    payload["api_can_enable_autonomous_trading"] = False
    return payload


def _slice(*names: str) -> dict[str, Any]:
    reports = V84ReportFactory().build()
