    ...
    return {
        "report": {
            ...
            "note": (
                ...
                "2026-07-16): the AutoPromotionEngine requires predictive gates "
                "plus receipt-bounded post-registration witnessed-fill evidence "
                "before adding a scope to the fused ensemble; midpoint/maker "
                "counterfactual ROI is report-only. This report is the human-"
                "readable evidence surface. Demotion is automatic and instant. Live "
