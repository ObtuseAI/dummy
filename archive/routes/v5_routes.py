"""Dashboard V5 routes for Dummy canonical identity and V5 reports."""
...
async def migration() -> dict[str, Any]:
    path = ARTIFACTS / "path_migration_manifest_v1.json"
    if path.exists():
        return json.loads(path.read_text())
    return {"error": "migration_manifest_not_generated"}
