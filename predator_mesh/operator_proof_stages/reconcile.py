...
VERIFICATION_COMMANDS = [
    "python -m py_compile predator_mesh/operator_proof_stages/reconcile.py predator_mesh/operator_proof_workflows.py scripts/run_dummy_reconcile_forensic_auto_orchestrator_v6.py",
...
class ReconcileForensicReportFactory:
