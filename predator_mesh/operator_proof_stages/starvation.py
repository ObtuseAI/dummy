...
VERIFICATION_COMMANDS = [
    "python -m py_compile predator_mesh/operator_proof_stages/starvation.py predator_mesh/operator_proof_workflows.py scripts/run_dummy_proof_starvation_stop_rule.py",
    "python scripts/run_dummy_proof_starvation_stop_rule.py",
    "python -m pytest tests/test_v295_to_v304_governance.py -q",
]


class ProofStarvationReportFactory:
