...
class MachineLearningForTradingAdapter(DummyAdapter):
    """Lightweight Dummy-native adapter wrapper for machine_learning_for_trading_adapter.
    ...
    name = "machine_learning_for_trading_adapter"
