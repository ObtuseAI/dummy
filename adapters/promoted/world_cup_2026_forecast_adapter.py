...
class WorldCup2026ForecastAdapter(DummyAdapter):
    """Lightweight Dummy-native adapter wrapper for world_cup_2026_forecast_adapter.
    ...
    name = "world_cup_2026_forecast_adapter"
