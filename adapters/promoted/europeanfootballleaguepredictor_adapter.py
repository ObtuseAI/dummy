...
class EuropeanFootballLeaguePredictorAdapter(DummyAdapter):
    """Lightweight Dummy-native adapter wrapper for EuropeanFootballLeaguePredictor_adapter.
    ...
    name = "EuropeanFootballLeaguePredictor_adapter"
