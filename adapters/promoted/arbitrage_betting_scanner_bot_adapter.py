...
class ArbitrageBettingScannerBotAdapter(DummyAdapter):
    """Lightweight Dummy-native adapter wrapper for arbitrage_betting_scanner_bot_adapter.
    ...
    name = "arbitrage_betting_scanner_bot_adapter"
