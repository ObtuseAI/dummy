def test_blunder_separation_recheck_v4():
    from archive.report_scripts.generate_v6_reports import generate_blunder_separation_recheck_v4
...
def test_dummy_independence_report_v2():
    from archive.report_scripts.generate_v6_reports import generate_dummy_independence_report_v2
