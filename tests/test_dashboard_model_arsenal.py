...
from autonomy import model_arsenal_status as arsenal
...
def test_model_arsenal_builder_is_exact_redacted_and_fail_closed(tmp_path, monkeypatch):
    ...
    secret = "sk-dashboard-secret-must-not-render"
...
def test_dashboard_model_arsenal_endpoint_is_read_only(monkeypatch):
    payload = {
