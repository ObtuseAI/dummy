...
async def test_kalshi_normalization_report_v3():
    from archive.report_scripts.generate_v6_reports import generate_kalshi_normalization_report_v3
...
async def test_real_market_snapshot_manifest_v1():
    from archive.report_scripts.generate_v6_reports import generate_real_market_snapshot_manifest_v1
