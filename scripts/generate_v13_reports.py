...
def generate_no_caps_config_modification_report_v13() -> dict[str, Any]:
    ...
    return {
        "generated_at": now_iso(),
        "workstream": "V13: No Caps Config Modification",
        "config_diff_empty": clean,
        "modified_by_v13": not clean,
...
def generate_blunder_separation_recheck_v13() -> dict[str, Any]:
    from scripts.generate_v12_reports import generate_blunder_separation_recheck_v12
...
def generate_dummy_canonical_identity_report_v13() -> dict[str, Any]:
    from scripts.generate_v12_reports import generate_dummy_canonical_identity_report_v12
