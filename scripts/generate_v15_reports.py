...
def generate_no_caps_config_modification_report_v15() -> dict[str, Any]:
    from scripts.generate_v14_reports import generate_no_caps_config_modification_report_v14
...
def generate_no_direct_order_bypass_report_v15() -> dict[str, Any]:
    from scripts.generate_v14_reports import generate_no_direct_order_bypass_report_v14
...
def generate_no_direct_cancel_bypass_report_v15() -> dict[str, Any]:
    from scripts.generate_v14_reports import generate_no_direct_cancel_bypass_report_v14
