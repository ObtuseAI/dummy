...
REQUIREMENTS: tuple[tuple[int, str, str, tuple[str, ...], str], ...] = (
    ...
    (31, "Observatory upgrade", "IMPLEMENTED_READ_ONLY", ("dummy/observatory", "dashboard/frontend/src/VNextObservatory.jsx"), "Eight evidence-linked panels plus claim and promotion projections are GET-only."),
...
def build_audit() -> dict[str, Any]:
    ...
    body: dict[str, Any] = {
        ...
        "validation": {
            "date": "2026-07-14",
            "ruff": "PASS",
            "focused_final_audit_tests": 16,
            "cross_vnext_tests": 197,
            "repository_tests": 5696,
            "dashboard_build": "PASS",
            "dashboard_entry_bundle_kb": 302.00,
            "previous_dashboard_entry_bundle_kb": 720.51,
            "oversized_chunk_warning": False,
        },
    }
