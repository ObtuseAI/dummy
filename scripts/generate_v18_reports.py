...
def generate_no_caps_config_modification_report_v18() -> dict[str, Any]:
    try:
        from scripts.generate_v17_reports import generate_no_caps_config_modification_report_v17
...
def generate_blunder_separation_recheck_v18() -> dict[str, Any]:
    try:
        from scripts.generate_v17_reports import generate_blunder_separation_recheck_v17
