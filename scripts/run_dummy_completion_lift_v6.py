"""Consolidated runner: completion_lift_v6 (V264). Read-only / dry by default. No submit, no approval writes, no runtime/approvals, no broker contact by default."""
...
from archive.report_scripts.generate_v264_reports import main as generate_main


def main() -> dict:
    final = generate_main()
    return {
        "runner": "completion_lift_v6",
        "verdict": final.get("verdict"),
        "completion_lift_v6_controller_status": final.get("completion_lift_v6_controller_status"),
