"""Consolidated runner: reconcile the first-live-proof state (V210). Dry by default; live requires exact CLI/env gate AND full authority. Fail-closed."""
...
from archive.report_scripts.generate_v210_reports import main as generate_main
...
def main() -> dict:
    ...
    final = generate_main()
    out = {
        "runner": "first_live_proof_reconcile",
