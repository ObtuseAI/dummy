...
def generate_blunder_separation_recheck_v11() -> dict[str, Any]:
    from scripts.generate_v10_reports import generate_blunder_separation_recheck_v10
...
def generate_dummy_canonical_identity_report_v11() -> dict[str, Any]:
    from scripts.generate_v10_reports import generate_dummy_canonical_identity_report_v10
