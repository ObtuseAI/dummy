"""Consolidated runner: proof_starvation_stop_rule (V303). Read-only / dry by default. No submit, no approval writes, no runtime/approvals, no broker contact by default."""
...
from scripts.generate_v303_reports import main as generate_main
...
def main() -> dict:
    ...
    return {
        ...
        "proof_starvation_stop_rule_controller_status": final.get("proof_starvation_stop_rule_controller_status"),
