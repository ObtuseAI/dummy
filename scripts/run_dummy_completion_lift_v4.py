"""Consolidated runner: completion_lift_v4 (V244). Read-only diagnostic. No submit, no approval writes, no runtime/approvals, no broker contact by default."""
...
from archive.report_scripts.generate_v244_reports import main as generate_main


def main() -> dict:
    final = generate_main()
    return {
        "runner": "completion_lift_v4",
        "verdict": final.get("verdict"),
        "completion_lift_lock_v4_controller_status": final.get("completion_lift_lock_v4_controller_status"),
