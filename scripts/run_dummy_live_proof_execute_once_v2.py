"""Consolidated runner: live-proof execute-once harness V2 (V242). Only fire surface in this bundle.
...
AND a passing V240 armable quorum. Absent any of these it stays fail-closed and submits nothing. Hard max one
attempt, auto-lock after attempt, no repeat submit, no direct broker bypass, no market order.
"""
...
from archive.report_scripts.generate_v242_reports import main as generate_main
...
def main() -> dict:
    ...
    final = generate_main()
    return {
        "runner": "live_proof_execute_once_v2",
        "live_mode_requested": live_requested,
        "verdict": final.get("verdict"),
        "execute_once_harness_controller_status": final.get("execute_once_harness_controller_status"),
