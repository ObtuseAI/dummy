"""Consolidated runner: review first-live-proof forensics (V211). Dry by default; live requires exact CLI/env gate AND full authority. Fail-closed."""
...
from archive.report_scripts.generate_v211_reports import main as generate_main
...
def main() -> dict:
    ...
    final = generate_main()
    out = {
        "runner": "first_live_proof_forensics",
