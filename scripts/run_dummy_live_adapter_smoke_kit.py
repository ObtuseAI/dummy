"""Consolidated runner: live_adapter_smoke_kit (V258). Read-only / dry by default. No submit, no approval writes, no runtime/approvals, no broker contact by default."""
...
from archive.report_scripts.generate_v258_reports import main as generate_main


def main() -> dict:
    final = generate_main()
    return {
        "runner": "live_adapter_smoke_kit",
        "verdict": final.get("verdict"),
        "adapter_smoke_kit_controller_status": final.get("adapter_smoke_kit_controller_status"),
