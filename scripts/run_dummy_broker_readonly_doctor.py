"""Consolidated runner: broker_readonly_doctor (V239). Read-only diagnostic. No submit, no approval writes, no runtime/approvals, no broker contact by default."""
...
from archive.report_scripts.generate_v239_reports import main as generate_main


def main() -> dict:
    final = generate_main()
    return {
        "runner": "broker_readonly_doctor",
        "verdict": final.get("verdict"),
        "broker_readonly_doctor_controller_status": final.get("broker_readonly_doctor_controller_status"),
