...
' console window. Regular python.exe so stdout redirects to the log.
Set shell = CreateObject("WScript.Shell")
shell.CurrentDirectory = "C:\src\engine\dummy"
shell.Run "cmd /c C:\Python314\python.exe scripts\run_dummy_signal_prune.py --apply --settled-before-days 2 >> runtime\autonomy\signal_prune_stdout.log 2>&1", 0, False
