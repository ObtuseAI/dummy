"""Consolidated runner: execute_once_final_proof_v7 (V298). Read-only / dry by default. No submit, no approval writes, no runtime/approvals, no broker contact by default."""
...
from scripts.generate_v298_reports import main as generate_main
...
def main() -> dict:
    ...
    return {
        ...
        "execute_once_final_proof_runner_v7_controller_status": final.get("execute_once_final_proof_runner_v7_controller_status"),
